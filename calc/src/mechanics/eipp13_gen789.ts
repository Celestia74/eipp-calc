...
export function calculateSMSSSV(
  ...
  if (field.defenderSide.isProtected && (defender.item === 'Immunity Idol' || !breaksProtect)) {
    if (defender.item === 'Immunity Idol') {desc.defenderItem = defender.item};
  ...
  if (defender.types[0] === defender.types[1] && defender.types[0] === defender.types[2]) {
  typeEffectiveness = type1Effectiveness;
  } else if (defender.types[0] === defender.types[1] || defender.types[0] == defender.types[2]) {
    if (defender.types[0] === defender.types[1]) {
    typeEffectiveness = type1Effectiveness * type3Effectiveness;
    } else {typeEffectiveness = type1Effectiveness * type2Effectiveness};
  } else if (defender.types[1] === defender.types[2]) {typeEffectiveness = type1Effectiveness * type2Effectiveness;
  } else {typeEffectiveness = type1Effectiveness * type2Effectiveness * type3Effectiveness};
